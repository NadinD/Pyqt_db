...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(852, 527)
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(Dialog)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.tableUnit = QtWidgets.QTableWidget(Dialog)
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Название подразделения"))
        item = self.tableUnit.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "Сокращенное название"))
        item = self.tableUnit.horizontalHeaderItem(3)
        item.setText(_translate("Dialog", "Вышестоящее подразделение"))
        self.btUnitAdd.setText(_translate("Dialog", "Добавить строку ..."))
        self.btUnitUpdate.setText(_translate("Dialog", "Обновить строку ..."))
        self.btUnitDel.setText(_translate("Dialog", "Удалить строку ..."))
        self.btUnitFind.setText(_translate("Dialog", "Поиск ..."))
